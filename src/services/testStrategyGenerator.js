...

{
  ...
  async callGroqAPI(prompt) {
    const messages = [
      { role: 'system', content: 'You are a senior QA architect generating enterprise test strategy documents. Always return valid JSON only — no markdown, no code fences, no explanatory text.' },
